...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26-Out-2020 às 06:43
...
-- --------------------------------------------------------
SELECT idpedidos, nomeCliente, endereco, telefone, Produto, valorUnitario, quantidade, valorUnitario * quantidade AS Total FROM pedidos;
--
